...
function enemy_init() {
  ...
  enemy.stats[ENEMY_ZOMBIE] = {name:"Corrupted Human", hp:30, atk_min:6, atk_max:12, gold_min:10, gold_max:30, category:ENEMY_CATEGORY_UNDEAD};
  ...
  enemy.stats[ENEMY_CYBORG] = {name:"Decimated Human", hp:60, atk_min:10, atk_max:16, gold_min:40, gold_max:60, category:ENEMY_CATEGORY_DEMON};
  ...
  enemy.stats[ENEMY_DRONE] = {name:"Maintenance Drone", hp:50, atk_min:8, atk_max:15, gold_min:40, gold_max:80, category:ENEMY_CATEGORY_AUTOMATON};
  ...
  enemy.stats[ENEMY_KILLBOT] = {name:"Defender Drone", hp:200, atk_min:20, atk_max:40, gold_min:120, gold_max:300, category:ENEMY_CATEGORY_AUTOMATON};
  ...
  enemy.stats[ENEMY_SENTINEL] = {name:"Destroyer Drone", hp:500, atk_min:30, atk_max:80, gold_min:500, gold_max:500, category:ENEMY_CATEGORY_AUTOMATON};
